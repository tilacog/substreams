...
fn test_sum_big_int(output: &impl store::StoreAddBigInt) {
    output.add(
        1,
...
#[substreams::handlers::store]
fn test_sum_int64(o: &impl store::StoreAddInt64) {
    o.add(1, "sum.int.64".to_string(), 10);
    o.add(1, "sum.int.64".to_string(), 10);
}

#[substreams::handlers::store]
fn test_sum_float64(o: &impl store::StoreAddFloat64) {
    o.add(1, "sum.float.64".to_string(), 10.75);
    o.add(1, "sum.float.64".to_string(), 10.75);
}

#[substreams::handlers::store]
fn test_sum_big_float_small_number(o: &impl store::StoreAddBigFloat) {
    o.add(
        1,
...
#[substreams::handlers::store]
fn test_sum_big_float_big_number(s: &impl store::StoreAddBigFloat) {
    s.add(
        1,
        "sum.big.float".to_string(),
...
#[substreams::handlers::store]
fn test_set_min_int64(s: &impl store::StoreMinInt64) {
    s.min(1, "set_min_int64".to_string(), 5);
    s.min(1, "set_min_int64".to_string(), 2);
}

#[substreams::handlers::store]
fn test_set_min_bigint(s: &impl store::StoreMinBigInt) {
    s.min(
        1,
...
#[substreams::handlers::store]
fn test_set_min_float64(s: &impl store::StoreMinFloat64) {
    s.min(1, "set_min_float64".to_string(), 10.05);
    s.min(1, "set_min_float64".to_string(), 10.04);
}

#[substreams::handlers::store]
fn test_set_min_bigfloat(s: &impl store::StoreMinBigFloat) {
    s.min(
        1,
...
#[substreams::handlers::store]
fn test_set_max_int64(s: &impl store::StoreMaxInt64) {
    s.max(1, "set_max_int64".to_string(), 5);
    s.max(1, "set_max_int64".to_string(), 2);
}

#[substreams::handlers::store]
fn test_set_max_bigint(my_store: &impl store::StoreMaxBigInt) {
    my_store.max(
        1,
...
#[substreams::handlers::store]
fn test_set_max_float64(s: &impl store::StoreMaxFloat64) {
    s.max(1, "set_max_float64".to_string(), 10.05);
    s.max(1, "set_max_float64".to_string(), 10.04);
}

#[substreams::handlers::store]
fn test_set_max_bigfloat(s: &impl store::StoreMaxBigFloat) {
    s.max(
        1,
...
#[substreams::handlers::store]
extern "C" fn test_set_delete_prefix(s: &impl store::StoreSet) {
...
#[substreams::handlers::store]
extern "C" fn test_append_empty_string_on_same_key(s: &impl store::StoreAppend) {
    s.append(1, "key".to_string(), &"string1".to_string());
    s.append(1, "key".to_string(), &"".to_string());
}

#[substreams::handlers::store]
extern "C" fn test_append_string_on_same_key(s: &impl store::StoreAppend) {
    s.append(1, "key".to_string(), &"string1".to_string());
    s.append(1, "key".to_string(), &"string2".to_string());
}

#[substreams::handlers::store]
extern "C" fn test_append_string_on_different_key(s: &impl store::StoreAppend) {
    s.append(1, "key".to_string(), &"string1".to_string());
    s.append(1, "key1".to_string(), &"string2".to_string());
}

#[substreams::handlers::store]
extern "C" fn test_append_empty_bytes_on_same_key(s: &impl store::StoreAppend) {
    s.append_bytes(1, "key".to_string(), &"string1".as_bytes().to_vec());
    s.append_bytes(1, "key".to_string(), &vec![]);
}

#[substreams::handlers::store]
extern "C" fn test_append_bytes_on_same_key(s: &impl store::StoreAppend) {
    s.append_bytes(1, "key".to_string(), &"string1".as_bytes().to_vec());
    s.append_bytes(1, "key".to_string(), &"string2".as_bytes().to_vec());
}

#[substreams::handlers::store]
extern "C" fn test_append_bytes_on_different_key(s: &impl store::StoreAppend) {
    s.append_bytes(1, "key".to_string(), &"string1".as_bytes().to_vec());
